...
const benefits = [
  {
    title: "Сильный визуал + ясная продуктовая логика",
    description:
      "Каждый экран решает конкретную задачу: быстрее донести ценность, снизить трение и подтолкнуть к действию.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Один главный CTA в фокусе экрана, логичные сценарии и конкретные офферы без воды.",
  },
  {
    title: "Mobile‑first подход",
    description:
      "Сначала удобство на телефоне: плотная иерархия, крупные зоны нажатия и контрастные состояния.",
  },
  {
    title: "Быстро и поддерживаемо",
    description:
      "Лёгкий фронтенд без тяжёлых фреймворков, аккуратный код и бережная работа с анимациями.",
  },
];
...
const faq = [
  {
    ...
    answer:
      "Напишите в Telegram, коротко опишите задачу и сроки. После брифа получите предложение с этапами и стоимостью.",
  },
  {
    question: "Можно ли уложиться в жёсткий дедлайн?",
    answer:
      "Да, если есть свободный слот. Срочные задачи обычно запускаются с отдельным коэффициентом по сроку.",
  },
  {
    question: "Что входит в результат?",
    answer:
      "Готовые макеты в Figma, система отступов и стилей, а также рекомендации по передаче в разработку.",
  },
  {
    ...
    <div className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top,_#34115c,_#050312_55%,_#02010a_80%)] text-slate-100">
          ...
          <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
            <div className="max-w-2xl space-y-4">
              ...
              <h2 className="text-2xl font-semibold text-slate-50 sm:text-3xl">
                Сильный визуал + ясная продуктовая логика
              </h2>
              <p className="text-sm leading-relaxed text-slate-300 sm:text-base">
                Каждый экран решает конкретную задачу: быстрее донести ценность, снять
                трение и подтолкнуть к действию.
              </p>
            </div>
          ...
          <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
            <div className="grid gap-10 lg:grid-cols-[1.1fr_minmax(0,1fr)] lg:items-start">
              <div className="space-y-4">
                ...
                <h2 className="text-2xl font-semibold text-slate-50 sm:text-3xl">
                  Почему со мной работают продуктовые команды
                </h2>
                <p className="text-sm leading-relaxed text-slate-300 sm:text-base">
                  Прозрачный процесс и конкретные результаты. Клиенты получают структуру,
                  визуальную систему и файлы, готовые к передаче в разработку без хаоса в
                  слоях.
                </p>
        ...
        <section className="border-b border-white/5 bg-gradient-to-b from-transparent via-fuchsia-500/5 to-black">
          <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
            <div className="mx-auto max-w-2xl space-y-6 text-center">
              <p className="text-xs font-medium uppercase tracking-[0.26em] text-fuchsia-300">
                Готовы сделать интерфейс, который запоминается и конвертирует?
              </p>
              <h2 className="text-2xl font-semibold text-slate-50 sm:text-3xl">
                Напишите 3–4 строки о проекте: ниша, цель, сроки.
              </h2>
              <p className="text-sm leading-relaxed text-slate-300 sm:text-base">
                В ответ получите понятный план и варианты сотрудничества.
              </p>
      ...
      <footer className="border-t border-white/10 bg-black/80">
        <div className="mx-auto flex max-w-6xl flex-col justify-between gap-3 px-4 py-6 text-[11px] text-slate-500 sm:flex-row sm:items-center sm:px-6 lg:px-8">
          <span>
            © Алиса Панькина · Digital artist · UI designer · Premium dark visuals
          </span>
        </div>
      </footer>
    </div>
